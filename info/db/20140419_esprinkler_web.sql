...
--
-- Host: localhost
-- Generation Time: Apr 20, 2014 at 01:13 AM
...
--
-- Table structure for table `pi_manual`
--

CREATE TABLE IF NOT EXISTS `pi_manual` (
  `pi_manual_task` varchar(255) NOT NULL,
  `created_date` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pi_manual`
--

INSERT INTO `pi_manual` (`pi_manual_task`, `created_date`) VALUES
('on', '2014-04-19 20:00:08');
...
CREATE TABLE IF NOT EXISTS `settingsconfig` (
  ...
  `sc_sprinkler_mode` enum('manual','auto') NOT NULL DEFAULT 'manual',
...
INSERT INTO `settingsconfig` (`sc_id`, `sc_site_title`, `sc_sprinkler_location`, `sc_sprinkler_mode`, `sc_last_updated`) VALUES
(1, 'eSprinkler - Web', 'Richardson, TX', 'manual', '2013-03-10 00:00:00');
...
ALTER TABLE `settingsconfig` CHANGE `sc_sprinkler_mode` `sc_sprinkler_mode` INT NOT NULL ;
