    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">             
                ...
                <li>
                    <a href="<?php echo HOME_PAGE; ?>?pg=set_location"><i class="fa fa-edit fa-fw"></i>&nbsp;Set Location</a>
                </li>
                <li>
                    <a href="<?php echo HOME_PAGE; ?>?pg=set_moisture_level"><i class="fa fa-wrench fa-fw"></i>&nbsp;Set Moisture Level</a>
                </li>
                <li>
                    <a href="<?php echo HOME_PAGE; ?>?pg=set_mode"><i class="fa fa-wrench fa-fw"></i>&nbsp;Set Mode</a>
                </li>  
                <li>
                    <a href="<?php echo HOME_PAGE; ?>?pg=manual_control"><i class="fa fa-wrench fa-fw"></i>&nbsp;Manual Control</a>
                </li>
                <li>
                    <a href="<?php echo HOME_PAGE; ?>?pg=scheduler"><i class="fa fa-wrench fa-fw"></i>&nbsp;Scheduler</a>
                </li>
                <li>
                    <a href="<?php echo HOME_PAGE; ?>?pg=weather"><i class="fa fa-table fa-fw"></i>&nbsp;Weather</a>
                </li>                 
                <li>
                    <a href="<?php echo HOME_PAGE; ?>?pg=status"><i class="fa fa-table fa-fw"></i>&nbsp;Status</a>
                </li>     
            </ul>
            <!-- /#side-menu -->
        </div>
